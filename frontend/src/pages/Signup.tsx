...
제2조 (정의)
① "서비스"란 회사가 제공하는 CJ ONE 포인트 적립·사용, CGV 영화 예매 등 통합 멤버십 서비스를 의미합니다.
...
3. 수신 동의 철회
 ...
 - 수신 거부 후에도 거래 관련 안내(예매 확인, 결제 완료 등)는 계속 발송됩니다.
