...
export default function MyReviews() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-ink mb-6">내 리뷰</h1>
      {reviews.length === 0 ? (
        ...
        <div className="space-y-4">
          {reviews.map(review => (
            <div key={review.id} className="bg-white rounded-xl shadow-sm p-5 border border-line">
              ...
              {review.content && (
                <p className="text-ink-soft text-sm mb-3">{review.content}</p>
              )}
