  ...
  return (
    <div className="flex items-center justify-between py-4 border-b border-line last:border-0">
      ...
      <button
        ...
        className={`relative w-11 h-6 rounded-full transition-colors ${checked ? 'bg-gilt' : 'bg-ink-faint/35'}`}
      >
...
export default function MyNotificationSettings() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-ink mb-6">알림 설정</h1>

      <div className="bg-white rounded-xl shadow-sm p-5 mb-4">
        <h2 className="font-semibold text-ink mb-2">채널 설정</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm p-5 mb-6">
        <h2 className="font-semibold text-ink mb-2">알림 종류</h2>
        <Toggle
          label="예약 알림"
      ...
      <button
        onClick={handleSave}
        disabled={saving}
        className="w-full py-3 bg-gilt text-white font-semibold rounded-xl hover:brightness-105 disabled:opacity-50 transition-colors"
      >
